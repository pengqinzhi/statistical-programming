...
public class UDPServer {
    ...
    public static void main(String[] args) {
        ...
        BigInteger b = new BigInteger(2046, rnd);
        System.out.println("Bob's secret integer:b = " + b);
        ...
        System.out.println("receive A from Alice: " + A);

        // Bob replies with B = g^b mod p.
        BigInteger B = g.modPow(b, p);
        System.out.println("send B to Alice: " + B);
